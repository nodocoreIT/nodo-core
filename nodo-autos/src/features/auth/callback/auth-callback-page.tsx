    ...
    const settle = async () => {
      ...
      if (mustReset) {
        if (type !== "recovery") {
          ...
          window.location.replace(`/nodo-autos/login?${qs.toString()}`);
          return;
        }
  ...
  if (error && ready) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-paper px-4 text-center">
        ...
        <a href="/nodo-autos/login" className="text-sm text-navy underline">
          Volver al login
        </a>
      </div>
    );
            ...
            <RequiredPasswordForm
              ...
              description={
                inviterName
                  ...
                  : "Te invitaron a participar de Nodo Autos. Elegí tu contraseña para continuar."
              }
