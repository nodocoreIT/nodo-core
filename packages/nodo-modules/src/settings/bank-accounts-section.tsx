...
import { formatCurrencyInput, formatMoney, parseCurrencyInput } from "../lib/format-money";
...
function accountToForm(account: BankAccount): typeof EMPTY_FORM {
  return {
...
export function BankAccountsSection() {
  const { bankAccounts } = useSettingsModule();
              ...
              onValueChange={(v) => {
                ...
                setForm({
                  ...
                  initial_balance_input: form.initial_balance_input
                    ? formatCurrencyInput(form.initial_balance_input.replace(/\D/g, ""), currency)
                    : "",
                });
              }}
            >
