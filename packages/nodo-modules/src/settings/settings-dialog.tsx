...
export function SettingsDialog({ open, onOpenChange, initialTab }: SettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="w-[95vw] sm:max-w-4xl h-[92vh] md:h-[min(800px,90vh)] flex flex-col sm:flex-row gap-0 p-0 overflow-hidden bg-white data-[state=open]:animate-none data-[state=closed]:animate-none">
