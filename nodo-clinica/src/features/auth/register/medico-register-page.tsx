...
export function MedicoRegisterPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Insert profile row — the DB trigger may handle this, but we ensure it
    ...
    <div className="min-h-screen flex items-center justify-center bg-paper p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-navy font-display">Registro médico</h1>
          <p className="text-slate2 text-sm mt-1">Creá tu cuenta de profesional en Nodo Clínica</p>
        </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="MN 12345" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="email" placeholder="doctor@email.com" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
