...
export default function RegistroMedicoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await clinicApi.register({ email, fullName, role: "medico" });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-teal-50/40 flex items-center justify-center py-8 px-4">
