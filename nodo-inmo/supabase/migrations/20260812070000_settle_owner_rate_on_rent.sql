-- Bugfix: commission_rate mostrado en la rendición se calculaba dividiendo
-- por el bruto (alquiler + expensas/conceptos), pero la comisión en sí ya se
-- calcula solo sobre el alquiler desde el fix anterior — dividir por el
-- bruto subestima el % mostrado (ej. 10% real aparecía como 8%). Se corrige
-- para dividir por v_rent_gross, consistente con cómo se calcula v_commission.
