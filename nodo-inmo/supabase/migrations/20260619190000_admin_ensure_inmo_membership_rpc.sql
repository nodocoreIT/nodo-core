-- Landing dashboard provisions Inmo via service_role; shared may not be an exposed
-- PostgREST schema, so membership setup runs in a public RPC (security definer).
