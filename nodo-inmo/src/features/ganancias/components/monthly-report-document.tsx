...
const styles = StyleSheet.create({
  page: { fontFamily: "Helvetica", fontSize: 9, padding: 40, color: "#000000" },
  header: {
    flexDirection: "row",
  ...
  brand: { fontSize: 14, fontFamily: "Helvetica-Bold", color: "#000000" },
  ...
  head: { fontFamily: "Helvetica-Bold", backgroundColor: "#f1f5f9", color: "#000000" },
  cDate: { width: "10%" },
  cDetail: { width: "36%" },
  cOrigin: { width: "12%" },
  cAccount: { width: "16%" },
