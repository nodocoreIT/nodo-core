...
import type { ObraThemeSettings } from "@/lib/obra/theme-settings";
import { DEFAULT_THEME_SETTINGS } from "@/lib/obra/theme-settings";
...
interface ThemeSettingsPanelProps {
  ...
  onChange: (patch: Partial<ObraThemeSettings>) => void;
  onReset?: () => void;
  compact?: boolean;
}
    ...
    <div className={compact ? "space-y-2" : "space-y-2 py-2"}>
      ...
      <div className="space-y-2 border-t border-border pt-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          {(
            [
              { id: "default" as const, label: "Nodo Obra" },
