...
/**
 * Acepta ID del calendario, URL pública de embed o código iframe de Google.
 */
...
/** URL igual al snippet oficial de Google (vista semanal). */
...
/** Vista agenda de un solo día (hoy / mañana). */
